...
export declare const GL_COMPRESSED_RGBA8_ETC2_EAC = 37493

/** WEBGL_compressed_texture_etc: Compresses sRBG8 data with no alpha channel. */
export declare const GL_COMPRESSED_SRGB8_ETC2 = 37494
...
export declare const GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC = 37495
...
export declare const GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2 = 37496
...
export declare const GL_COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL = 35986
...
export declare const GL_COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL = 34798

/** WEBGL_depth_texture: Unsigned integer type for 24-bit depth texture data. */
export declare const GL_UNSIGNED_INT_24_8_WEBGL = 34042
...
export declare const GL_RGBA32F_EXT = 34836

/** WEBGL_color_buffer_float: RGB 32-bit floating-point color-renderable format. */
export declare const GL_RGB32F_EXT = 34837

/** WEBGL_color_buffer_float: */
export declare const GL_FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT = 33297

/** WEBGL_color_buffer_float: */
export declare const GL_UNSIGNED_NORMALIZED_EXT = 35863
...
export declare const GL_SRGB_EXT = 35904

/** EXT_sRGB: Unsized sRGB format with unsized alpha component. */
export declare const GL_SRGB_ALPHA_EXT = 35906

/** EXT_sRGB: Sized (8-bit) sRGB and alpha formats. */
export declare const GL_SRGB8_ALPHA8_EXT = 35907

/** EXT_sRGB: Returns the framebuffer color encoding. */
export declare const GL_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING_EXT = 33296
...
export declare const GL_FRAGMENT_SHADER_DERIVATIVE_HINT_OES = 35723

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT0_WEBGL = 36064

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT1_WEBGL = 36065

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT2_WEBGL = 36066

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT3_WEBGL = 36067

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT4_WEBGL = 36068

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT5_WEBGL = 36069

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT6_WEBGL = 36070

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT7_WEBGL = 36071

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT8_WEBGL = 36072

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT9_WEBGL = 36073

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT10_WEBGL = 36074

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT11_WEBGL = 36075

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT12_WEBGL = 36076

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT13_WEBGL = 36077

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT14_WEBGL = 36078

/** WEBGL_draw_buffers: Framebuffer color attachment point */
export declare const GL_COLOR_ATTACHMENT15_WEBGL = 36079

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER0_WEBGL = 34853

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER1_WEBGL = 34854

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER2_WEBGL = 34855

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER3_WEBGL = 34856

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER4_WEBGL = 34857

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER5_WEBGL = 34858

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER6_WEBGL = 34859

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER7_WEBGL = 34860

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER8_WEBGL = 34861

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER9_WEBGL = 34862

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER10_WEBGL = 34863

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER11_WEBGL = 34864

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER12_WEBGL = 34865

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER13_WEBGL = 34866

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER14_WEBGL = 34867

/** WEBGL_draw_buffers: Draw buffer */
export declare const GL_DRAW_BUFFER15_WEBGL = 34868

/** WEBGL_draw_buffers: Maximum number of framebuffer color attachment points */
export declare const GL_MAX_COLOR_ATTACHMENTS_WEBGL = 36063

/** WEBGL_draw_buffers: Maximum number of draw buffers */
export declare const GL_MAX_DRAW_BUFFERS_WEBGL = 34852

/** OES_vertex_array_object: The bound vertex array object (VAO). */
export declare const GL_VERTEX_ARRAY_BINDING_OES = 34229

/** EXT_disjoint_timer_query: The number of bits used to hold the query result for the given target. */
export declare const GL_QUERY_COUNTER_BITS_EXT = 34916

/** EXT_disjoint_timer_query: The currently active query. */
export declare const GL_CURRENT_QUERY_EXT = 34917

/** EXT_disjoint_timer_query: The query result. */
export declare const GL_QUERY_RESULT_EXT = 34918

/** EXT_disjoint_timer_query: A Boolean indicating whether or not a query result is available. */
export declare const GL_QUERY_RESULT_AVAILABLE_EXT = 34919

/** EXT_disjoint_timer_query: Elapsed time (in nanoseconds). */
export declare const GL_TIME_ELAPSED_EXT = 35007

/** EXT_disjoint_timer_query: The current time. */
export declare const GL_TIMESTAMP_EXT = 36392

/** EXT_disjoint_timer_query: A Boolean indicating whether or not the GPU performed any disjoint operation. */
export declare const GL_GPU_DISJOINT_EXT = 36795
