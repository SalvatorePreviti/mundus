 ...
 */
export const angleDeltaSigned = /*#__PURE__*/ /*#__INLINE__*/ (sourceRadians: number, targetRadians: number): number =>
 ...
 */
export const lerpInverse = /*#__PURE__*/ (v: number, from: number, to: number): number => (v - from) / (to - from) || 0
...
export const mathRandomRange = /*#__PURE__*/ (minimum: number, maximum: number) => lerp(mathRandom(), minimum, maximum)
